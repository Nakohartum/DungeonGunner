...
namespace Dungeon
{
    ...
    public class DungeonLevelSO : ScriptableObject
    {
        ...
        [Space(10)]
        [Header("ROOM TEMPLATES FOR THE LEVEL")]

        #endregion

        #region Tooltip

        [Tooltip("Populate the list with the room templates that you want to be part of the level. You need to ensure" +
                 " that room templates are included for all room node types that are specified in the Room Node Graph for the level")]

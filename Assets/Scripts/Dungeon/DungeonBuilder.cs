...
namespace Dungeon
{
    ...
    public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
    {
        ...
        public bool GenerateDungeon(DungeonLevelSO currentDungeonLevel)
        {
            ...
            while (!dungeonBuildSuccessful && dungeonBuildAttempts < Settings.maxDungeonBiuldAttempts)
            {
        ...
        private bool AttemptToBuildRandomDungeon(RoomNodeGraphSO romeNodeGraph)
        {

            Queue<RoomNodeSO> openRoomNodeQueue = new Queue<RoomNodeSO>();
            RoomNodeSO entranceNode = romeNodeGraph.GetRoomNode(roomNodeTypeList.list.Find(x => x.isEntrance));
            ...
            noRoomOverlaps = ProcessRoomsInOpenRoomNodeQueue(romeNodeGraph, openRoomNodeQueue, noRoomOverlaps);
        ...
        private RoomTemplateSO GetRandomRoomTemplateForRoomConsistentWithParent(RoomNodeSO roomNode,
            Doorway doorwayParent)
        {
        ...
        private Room CreateRoomFromRoomTemplate(RoomTemplateSO roomTemplate, RoomNodeSO roomNode)
        {
            ...
            if (roomNode.parentRoomNodeIDList.Count == 0)
            {
                ...
                GameManager.GameManager.Instance.SetCurrentRoom(room);
            }
            else
            {
            ...
            if (room.GetNumberOfEnemiesToSpawn(GameManager.GameManager.Instance.GetCurrentDungeonLevel()) == 0)
            {

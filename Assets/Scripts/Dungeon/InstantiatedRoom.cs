...
namespace Dungeon
{
    ...
    public class InstantiatedRoom : MonoBehaviour
    {
        ...
        [HideInInspector] public int[,] aStarItemsObstacles;
        ...
        {
            if (other.CompareTag(Settings.playerTag) && room != GameManager.GameManager.Instance.GetCurrentRoom())
            {
        ...
        {
            aStarItemsObstacles = new int[room.templateUpperBounds.x - room.templateLowerBounds.x + 1,
                room.templateUpperBounds.y - room.templateLowerBounds.y + 1];
        }
        ...
        private void InitializeItemObstaclesArray()
        {
            for (int x = 0; x < (room.templateUpperBounds.x - room.templateLowerBounds.x + 1); x++)
            {
                for (int y = 0; y < (room.templateUpperBounds.y - room.templateLowerBounds.y + 1); y++)
                {
                    aStarItemsObstacles[x, y] = Settings.defaultAStarMovementPenalty;
                }
            }
        }
        ...
        public void UpdateMoveableObstacles()
        {
            ...
            foreach (var moveItem in moveableItemsList)
            {
                ...
                for (int i = colliderBoundsMin.x; i <= colliderBoundsMax.x; i++)
                {
                    ...
                    {
                        aStarItemsObstacles[i - room.templateLowerBounds.x, j - room.templateLowerBounds.y] = 0;
                    }
                }
            }
        }

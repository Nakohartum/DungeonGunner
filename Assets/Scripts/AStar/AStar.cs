    ...
    public static class AStar
    {
            ...
            GridNodes gridNodes, HashSet<Node> closedNodeHashSet, InstantiatedRoom instantiatedRoom)
        {
            ...
            int itemObstacleForGridSpace =
                instantiatedRoom.aStarItemsObstacles[neighbourNodeXPosition, neighbourNodeYPosition];
            if (closedNodeHashSet.Contains(neighbourNode) || itemObstacleForGridSpace == 0 || movementPenaltyForGridSpace == 0)
            {
                return null;
            }

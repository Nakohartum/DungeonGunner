...
namespace Sounds
{
    [CreateAssetMenu(fileName = "MusicTrack_", menuName = "Scriptable Objects/Sounds/MusicTrack", order = 0)]
    public class MusicTrackSO : ScriptableObject
    {
        ...
        private void OnValidate()
        {
            ...
            HelperUtilities.ValidateCheckNullValues(this, nameof(musicClip), musicClip);

...
namespace Sounds
{
    [CreateAssetMenu(fileName = "SoundEffect_", menuName = "Scriptable Objects/Sounds/SoundEffect", order = 0)]
    public class SoundEffectSO : ScriptableObject
    {
        ...
        [Tooltip(
            "The minimum pitch variation for the sound effect. A random pitch variation will be generated between minimum and maximum values." +
        ...
        [Tooltip(
            "The maximum pitch variation for the sound effect. A random pitch variation will be generated between minimum and maximum values." +
            " A random pitch variation makes sound effects sound more natural")]

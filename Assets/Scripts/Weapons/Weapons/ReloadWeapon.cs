    ...
    public class ReloadWeapon : MonoBehaviour
    {
        ...
        private void StartReloadWeapon(ReloadWeaponEventArgs reloadWeaponEventArgs)
        {
            ...
            reloadWeaponCoroutine =
                StartCoroutine(
                    ReloadWeaponRoutine(reloadWeaponEventArgs.weapon, reloadWeaponEventArgs.topUpAmmoPercent));
        }
        ...
        private IEnumerator ReloadWeaponRoutine(Weapon weapon, int topUpAmmoPercent)
        {
            ...
            {
                int ammoIncrease =
                    Mathf.RoundToInt((weapon.weaponDetails.weaponAmmoCapacity * topUpAmmoPercent) / 100f);
            ...
            {
                weapon.weaponClipRemainigAmmo = weapon.weaponDetails.weaponClipCapacity;
            }
            ...
            {
                weapon.weaponClipRemainigAmmo = weapon.weaponRemainingAmmo;
            }

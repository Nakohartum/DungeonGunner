...
namespace Weapons
{
    ...
    public class WeaponShootEffect : MonoBehaviour
    {
        ...
        public void SetShootEffect(WeaponShootEffectSO shootEffect, float aimAngle)
        {
            ...
            SetShootEffectVelocityOverLifetime(shootEffect.velocityOverLifetimeMin,
                shootEffect.velocityOverLifetimeMax);
        }
        
        private void SetShootEffectColorGradient(Gradient gradient)
        {
            ParticleSystem.ColorOverLifetimeModule
                colorOverLifetimeModule = shootEffectParticleSystem.colorOverLifetime;

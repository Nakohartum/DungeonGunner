...
namespace Weapons.Ammo
{
    ...
    public class AmmoDetailsSO : ScriptableObject
    {
        ...
        [Tooltip(
            "Populate with the prefab to be used for the ammo. If multiple prefabs are specified then a random prefab from the array will" +
            " be selected. The prefab can be an ammo pattern - as long as it conforms to the IFireable intreface")]
        ...
        public float ammoSpreadMin = 0.0f;
        ...
        public float ammoSpreadMax = 0.0f;
        ...
        [Tooltip(
            "This is the minimum number of ammo that are spawned per shot. A random number of ammo are spawned between the min and max values")]
        ...
        [Tooltip(
            "This is the maximum number of ammo that are spawned per shot. A random number of ammo are spawned between the min and max values")]
        ...
        [Tooltip(
            "Minimum spawn interval time. The time interval in seconds between spawned ammo is a random value between min and max values specified")]

        #endregion

        public float ammoSpawnIntervalMin = 0;
        
        #region Tooltip

        [Tooltip(
            "Maximum spawn interval time. The time interval in seconds between spawned ammo is a random value between min and max values specified")]

        #endregion
        
        public float ammoSpawnIntervalMax = 0;
        ...
        [Tooltip(
            "Selected if an ammo trails is required, otherwise deselect. If selected then rest of the ammo trail values should be populated")]
        ...
        private void OnValidate()
        {
            ...
            HelperUtilities.ValidateCheckPositiveRange(this, nameof(ammoSpreadMin), ammoSpreadMin,
                nameof(ammoSpreadMax), ammoSpreadMax, true);

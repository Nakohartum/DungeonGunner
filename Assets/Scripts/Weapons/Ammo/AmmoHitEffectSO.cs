...
namespace Weapons.Ammo
{
    ...
    public class AmmoHitEffectSO : ScriptableObject
    {
        ...
        public float startParticleSpeed = 3.0f;
        
        #region Tooltip

        [Tooltip("The start particle lifetime for the particle effect")]
        ...
        [Tooltip(
            "The sprite for the particle effect. If none is specified then the default particle sprite will be used")]
        ...
        [Tooltip("ammoHitEffectPrefab contains the particle system for the shoot effect - and is configured by the ammoHitEffect SO")]

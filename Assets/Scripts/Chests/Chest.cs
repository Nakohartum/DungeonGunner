...
namespace Chests
{
    ...
    public class Chest : MonoBehaviour, IUseable
    {
        ...
        private void OpenChest()
        {
            ...
            {
                if (GameManager.GameManager.Instance.GetPlayer().IsWeaponHeldByPlayer(weaponDetails))
                    weaponDetails = null;
            }
        ...
        private void CollectHealthItem()
        {
            ...
            GameManager.GameManager.Instance.GetPlayer().health.AddHealth(healthPercent);
        ...
        private void CollectAmmoItem()
        {
            ...
            Player.Player player = GameManager.GameManager.Instance.GetPlayer();
        ...
        private void CollectWeaponItem()
        {
            ...
            if (!GameManager.GameManager.Instance.GetPlayer().IsWeaponHeldByPlayer(weaponDetails))
            {
                ...
                GameManager.GameManager.Instance.GetPlayer().AddWeaponToPlayer(weaponDetails);

...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    /// <summary>
    /// Open the room node graph editor window if a room node graph scriptable object asset is double clicked on the inspector
    /// </summary>
    ...
    private void DrawConnectionLine(RoomNodeSO parentRoomNode, RoomNodeSO childRoomNode)
    {
        ...
        Handles.DrawBezier(startPosition, endPosition, startPosition, endPosition, Color.white, 

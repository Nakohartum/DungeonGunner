...
namespace Enemies
{
    ...
    public class EnemyMovementAI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            playerReferencePosition = GameManager.GameManager.Instance.GetPlayer().GetPlayerPosition();
        }
        ...
        private void MoveEnemy()
        {
            ...
            if (!chasePlayer &&
                Vector3.Distance(transform.position, GameManager.GameManager.Instance.GetPlayer().GetPlayerPosition()) <
            ...
            if (currentEnemyPathRebuildCooldown <= 0f || Vector3.Distance(playerReferencePosition,
                    GameManager.GameManager.Instance.GetPlayer().GetPlayerPosition()) >
        ...
        {
            Room currentRoom = GameManager.GameManager.Instance.GetCurrentRoom();
            Grid grid = currentRoom.instantiatedRoom.grid;
            Vector3Int playerGridPosition = GetNearestNonObstaclePlayerPosition(currentRoom);
            Vector3Int enemyGridPosition = grid.WorldToCell(transform.position);
            movementSteps = AStar.AStar.BuildPath(currentRoom, enemyGridPosition, playerGridPosition);
            if (movementSteps != null)
            {
                movementSteps.Pop();
            }
        ...
        {
            Vector3 playerPosition = GameManager.GameManager.Instance.GetPlayer().GetPlayerPosition();
            ...
            int obstacle =
                Mathf.Min(currentRoom.instantiatedRoom.aStarMovementPenalty[adjustedPlayerCellPosition.x,
                    ...
                    currentRoom.instantiatedRoom.aStarItemsObstacles[adjustedPlayerCellPosition.x,
                        adjustedPlayerCellPosition.y]);
            if (obstacle != 0)
            {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    try
                    {
                        obstacle = Mathf.Min(
                            ...
                            currentRoom.instantiatedRoom.aStarItemsObstacles[
                                adjustedPlayerCellPosition.x + surroundingPositionList[index].x,
                                adjustedPlayerCellPosition.y + surroundingPositionList[index].y]);
                ...
                return (Vector3Int) currentRoom.spawnPositionArray[

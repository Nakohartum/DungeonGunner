...
namespace UI
{
    public class PauseMenuUI : MonoBehaviour
    {
        ...
        {
            HelperUtilities.ValidateCheckNullValues(this, nameof(musicLevelText), musicLevelText);
            HelperUtilities.ValidateCheckNullValues(this, nameof(soundsLevelText), soundsLevelText);
        }

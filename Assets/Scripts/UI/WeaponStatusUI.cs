...
namespace UI
{
    public class WeaponStatusUI : MonoBehaviour
    {
        ...
        [Tooltip("Populate with RectTransform of the child gameobject ReloadBar")]
        ...
        [Tooltip("Populate with Image component on the child gameobject BarImage")]
        ...
        private void Awake()
        {
            player = GameManager.GameManager.Instance.GetPlayer();
        }
        ...
        private void UpdateAmmoLoadedIcons(Weapon weapon)
        {
            ...
            for (int i = 0; i < weapon.weaponClipRemainigAmmo; i++)
            {
        ...
        {
            if ((!weapon.weaponDetails.hasInfiniteClipCapacity) && (weapon.weaponClipRemainigAmmo <= 0 || weapon.isWeaponReloading))
            {
                barImage.color = Color.red;
